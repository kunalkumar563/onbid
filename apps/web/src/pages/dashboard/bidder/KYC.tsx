              ...
              {step === 2 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                  ...
                  <div>
                    ...
                    <div style={{ border: '2px dashed #ddd', borderRadius: '8px', padding: '30px', textAlign: 'center', background: '#fafafa', cursor: 'pointer' }}>
                  ...
                  <div style={{ display: 'flex', gap: '15px', marginTop: '10px' }}>
                    ...
                    <button 
                      ...
                      disabled={loading}
                    >
                      {loading ? 'Verifying Documents...' : 'Submit for Verification'}
                    </button>
                  </div>
                </div>
              )}
